...
func NewClient[T any](app App, opts ...Option[T]) *Client[T] {
	...
	c.ChoiceCustomized = &ChoiceCustomizedServiceOp[T]{client: c}
	c.Content = &ContentServiceOp[T]{client: c}
	c.CrossBoarderProduct = &CrossBoarderProductServiceOp[T]{client: c}
	c.EarlyBirdPrice = &EarlyBirdPriceServiceOp[T]{client: c}
	c.ETickets = &ETicketsServiceOp[T]{client: c}
	c.FBL = &FBLServiceOp[T]{client: c}
	c.Finance = &FinanceServiceOp[T]{client: c}
	c.FirstMileBigbagonlyForCN = &FirstMileBigbagonlyForCNServiceOp[T]{client: c}
	c.Flexicombo = &FlexicomboServiceOp[T]{client: c}
	c.FreeShipping = &FreeShippingServiceOp[T]{client: c}
	c.Fulfillment = &FulfillmentServiceOp[T]{client: c}
	c.InstantMessaging = &InstantMessagingServiceOp[T]{client: c}
	c.LazadaDG = &LazadaDGServiceOp[T]{client: c}
	c.LazadaLogistics = &LazadaLogisticsServiceOp[T]{client: c}
	c.LazadaWalletCorporateTopUp = &LazadaWalletCorporateTopUpServiceOp[T]{client: c}
	c.LazLike = &LazLikeServiceOp[T]{client: c}
	c.LazLive = &LazLiveServiceOp[T]{client: c}
	c.LazPay = &LazPayServiceOp[T]{client: c}
	c.Logistics = &LogisticsServiceOp[T]{client: c}
	c.LogisticsStation = &LogisticsStationServiceOp[T]{client: c}
	...
	c.Seller = &SellerServiceOp[T]{client: c}
	c.SellerVoucher = &SellerVoucherServiceOp[T]{client: c}
	c.ServiceMarket = &ServiceMarketServiceOp[T]{client: c}
	c.SponsoredSolutions = &SponsoredSolutionsServiceOp[T]{client: c}
	c.StoreDecoration = &StoreDecorationServiceOp[T]{client: c}
	c.System = &SystemServiceOp[T]{client: c}
